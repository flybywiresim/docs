...
push the selector for `Managed Altitude Mode` (constraints are respected, also known as VNAV or [DES](../advanced-guides/flight-guidance/vertical-guidance/managed-modes.md#des-descent)) or pull the selector for `Selected Altitude Mode` (constraints are ignored, also known as [OP DES](../advanced-guides/flight-guidance/vertical-guidance/selected-modes.md#op-des-open-descent)). 
