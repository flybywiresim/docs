...
- Broken support for FSLTL Traffic (sim issue)
    ...
    !!! info "Root Cause for FSLTL + TCAS Issues"
        Unfortunately, this is an issue with how injected traffic uses certain APIs from MSFS. Asobo appears to be aware of the issue, and you can track it on the dev support forum link below:

        [AI aircraft generated airborne do not get returned with the GET_AIR_TRAFFIC Coherent call](https://devsupport.flightsimulator.com/questions/12949/ai-aircraft-generated-airborne-do-not-get-returned.html)
