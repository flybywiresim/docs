...
As we catch up to the profile you will notice the V/DEV indicator shift and match the altitude indicator. This informs the crew that we have caught up with the profile and the aircraft is now increase its descent rate to V/S -2000 ft.
...
!!! block ""
    ...
    !!! tip "Useful Tip"
        ...
        If ATC would want to provide a shortcut or earlier descent instructions additional indications will appear. See next section.
