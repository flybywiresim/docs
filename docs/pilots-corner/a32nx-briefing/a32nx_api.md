...
|              | A32NX_EFIS_R_NAVAID_2_MODE       | 0..2             | R/W        | Custom LVAR      | 0=OFF, 1=ADF, 2=VOR <br/>==(Experimental only)==                               |
...
|                   | AUTOPILOT_ON                        | -                | -          | SIMCONNECT EVENT | Send 2 times for AP1 and 2                                                |
...
| Function       | API Usage             | Values | Read/Write | Type        | Remark                    |
|:---------------|:----------------------|:-------|:-----------|:------------|:--------------------------|
| TERR ON ND L+R | BTN_TERRONND_1_ACTIVE | 0 \| 1 | R/W        | Custom LVAR | ==(not in Experimental)== |
|                | BTN_TERRONND_2_ACTIVE | 0 \| 1 | R/W        | Custom LVAR | ==(not in Experimental)== |
