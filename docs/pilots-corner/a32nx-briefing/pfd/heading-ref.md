...
<div style="position: relative; width: 413px; height: auto; margin-left: auto;  margin-right: auto;">
    ...
    <a href="/pilots-corner/a32nx-briefing/pfd/heading-ref/">       <div class="imagemap highlighted" style="position: absolute; left: 19.58%; top: 86.09%; width: 47.48%; height: 12.17%;"><span class="imagemapname">Heading Reference Line and Scale</span></div></a>
...
A white scale on a grey background moves in front of a fixed yellow reference line to show the actual magnetic heading. "TRU" will be displayed when the display shows true heading and not magnetic heading. This occurs when the latitude is above 73 degrees north or below 60 degrees south.
