...
<div style="position: relative; width: 413px; height: auto; margin-left: auto;  margin-right: auto;">
    ...
    <a href="/pilots-corner/a32nx/a32nx-briefing/pfd/heading-ref/">       <div class="imagemap highlighted" style="position: absolute; left: 19.58%; top: 86.09%; width: 47.48%; height: 12.17%;"><span class="imagemapname">Heading Reference Line and Scale</span></div></a>
...
This is a small green diamond that displays the aircraft's actual track. It is underneath the selected heading or track index. This takes into account any crosswinds that are changing the aircraft's track.
