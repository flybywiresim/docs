...
<div style="position: relative;">
    ...
    <a href="/pilots-corner/a32nx/a32nx-briefing/pfd/special-message-annunciators"><div class="imagemap highlighted" style="position: absolute; left: 21.22%; top:   63%; width: 43.08%; height:  31%;"><span class="imagemapname">Special Message and Common Mode Annunciators</span></div></a>
</div>
