...
!!! info "Expanded Information from FAA Instrument Procedure Handbook"
    ...
    **DA** - regarding in the precision approach at which a missed approach must be initiated if the required visual reference to continue the approach has not been established.
