...
3. [Pushback](#pushback)
4. [Engine Start](#engine-start)
5. [After Engine Start](#after-engine-start)
6. [Taxi](#taxi)
...
??? tip "How and Where"
    ...
    **Windows, Doors and Slides**
    ...
    To check windows, doors and slides, you can use the [SD](../a380x-briefing/flight-deck/main-panel/sd.md) page on 
...
??? Note "ENGINE START"
    Any engine can be started first, at the pilot's discretion.
...
??? tip "How and Where"
    ...
    * [Engine Master](../a380x-briefing/flight-deck/pedestal/engine-master.md)
...
??? note "Note: Bleed Air"
    ...
    **To start the engines, you need to have the APU available and the APU Bleed ON - see [Cockpit Preparation](02_cockpit-preparation.md#overhead-panel-center-bottom-to-top).**
    ...
    [//]: # (TODO)
    Please refer to the [A32NX Crossbleed Engine Start Guide](../../a32nx/a32nx-advanced-guides/engines/crossbleed-start.md)
...
??? note "FLAPS"
    During the [preparation of the FMS](03_preparing-fms.md#performance) we have calculated the 
...
??? note "Pitch Trim"
    ...
    [Pitch Trim Panel](../a380x-briefing/flight-deck/pedestal/trim-panel.md) (located on the pedestal)
...
??? tip "How and Where"
    ...
    * [Engine Start Selector](../a380x-briefing/flight-deck/ovhd/eng-start.md)
    * [APU Bleed](../a380x-briefing/flight-deck/ovhd/elec.md)
    * [Engine Anti-Ice](../a380x-briefing/flight-deck/ovhd/anti-ice.md)
    * [APU](../a380x-briefing/flight-deck/ovhd/elec.md)
    * [Ground Spoilers](../a380x-briefing/flight-deck/pedestal/speed-brake.md)
    * [Rudder Trim](../a380x-briefing/flight-deck/pedestal/trim-panel.md)
    * [Flaps](../a380x-briefing/flight-deck/pedestal/flap-lever.md)
    * [Pitch Trim](../a380x-briefing/flight-deck/main-panel/pfd.md)
    * [ECAM Status](../a380x-briefing/flight-deck/main-panel/sd.md) (Page STS)
    * [Flight Controls](../a380x-briefing/flight-deck/main-panel/sd.md) (Page F/CTL)
...
For additional information on signs and markings on the ground, please see our [Signage and Marking Guide](../../airliner/airliner-flying-guide/airport-signage.md).
...
??? note "NAVIGATION DISPLAY RANGE - OANS"
    ...
    See our [OANS Guide](../a380x-advanced-guides/oans-btv.md) for more information on how to use the OANS system.
...
??? tip "How and Where"
    ...
    * [Taxi ETACS](../a380x-briefing/flight-deck/glareshield/efis.md)
    * [Navigation Display Range](../a380x-briefing/flight-deck/glareshield/efis.md)
    * [Nose Lights](../a380x-briefing/flight-deck/ovhd/ext-lt.md)
    * [RWY Turn Off Lights](../a380x-briefing/flight-deck/ovhd/ext-lt.md)
    * [Parking Brake](../a380x-briefing/flight-deck/pedestal/parking-brake.md)
    * [Thrust Levers](../a380x-briefing/flight-deck/pedestal/throttle.md)
...
??? tip "How and Where"
    ...
    * [AFS](../a380x-briefing/flight-deck/glareshield/afs.md)
    * [PFD](../a380x-briefing/flight-deck/main-panel/pfd.md)
    * [ND](../a380x-briefing/flight-deck/main-panel/nd.md)
    * [Spoilers](../a380x-briefing/flight-deck/pedestal/speed-brake.md)
    * [Flaps](../a380x-briefing/flight-deck/pedestal/flap-lever.md)
    * [Auto Brake](../a380x-briefing/flight-deck/main-panel/center-right.md)
    * [Signs](../a380x-briefing/flight-deck/ovhd/signs.md)
    * [T.O Config](../a380x-briefing/flight-deck/pedestal/ecam-cp.md)
    * [T.O Memo](../a380x-briefing/flight-deck/main-panel/ewd.md)
    * [Cabin Ready](../a380x-briefing/flight-deck/ovhd/calls.md)
...
Continue with [Takeoff, climb and cruise](05_takeoff-climb-cruise.md)
