...
!!! warning "Disclaimer"
    The level of detail in this guide is meant to get a FlyByWire A380 beginner currently on approach to intercept the ILS and land the aircraft safely on the runway.
...
??? tip "End of Instrument Approach"
    ...
    - Verify that the correct ILS frequency is tuned in the `MFD-RNAV` page. We find the correct frequency on the approach chart.<br/> <p style="color:yellow; font-size:18px;">TODO: verify RNAV page location in MFD</p>
...
??? tip "ILS Localizer, Glideslope & APPR Mode"
    ...
    === "Turn on ILS scales"
        ...
        <p style="color:yellow; font-size:18px;">TODO: update PFD and ND examples</p>
