...
As we have continued to make improvements since that NOTAM was published the two most notable inclusions to date would be our new method of loading fuel and passengers onto the aircraft. You now have a great animated user interface to see passengers filling seats with a high degree of customization for both seat and weight allocation. See [Fuel and Weight Guide](../fbw-a32nx/feature-guides/loading-fuel-weight.md).

[image here]

Another notable inclusion would be our new Local Files feature shipped with SimBridge. This allows you to store a variety of PDFs and images for use during your flight. Get access to your own personal charts without requiring a 3rd party subscription! See [Local Files Guide Here](../fbw-a32nx/feature-guides/flypados3/charts.md#local-files).
