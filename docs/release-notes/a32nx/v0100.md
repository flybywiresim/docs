...
!!! note ""
    We are always looking for more help with translations. You can find more information on how to do so through our documentation [here](../../dev-corner/dev-guide/specific/flypad-localization.md).
