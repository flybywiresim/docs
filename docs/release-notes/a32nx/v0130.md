...
![a32nx-release-card130](../assets/a32nx_release_0130-feature.png)
...
- [x] **Brake Simulation**: New physics-based brake simulation for more realistic braking performance.
- [x] **Electrical System**: Improved electrical system startup behavior and power management.
- [x] **FCU & RA Failures**: Expanded failure modes for more in-depth training scenarios.
- [x] **FMGC & FCU Computer**: Fully simulated navigation and control units building upon 
- [x] **GPU Handling**: Enhanced ground power management for a more immersive experience. Now has connection logic and failure checks.
- [x] **FMS Refinements**: Numerous improvements to the Flight Management System, including better handling of flight plans, holds, and approach procedures.
- [x] **EFIS (PFD & ND)**: Performance and layout tweaks, including memory-leak fixes.

**Bug Fixes**

Over 30 fixes across APU fire detection, TCAS power, baro preselect, Portuguese station codes, airport loading timeouts, and more.
...
* [A32NX/FWC] Add A/THR LIMITED ECAM warning - @lukecologne (luke)
