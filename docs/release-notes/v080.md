...
[Hoppie ACARS Operation Guide](../fbw-a32nx/feature-guides/hoppie/index.md){.md-button}
...
![Web MCDU](../simbridge/assets/simbridge/web-mcdu-ipad.webp){loading=lazy}

[MCDU Web Interface Guide](../simbridge/remote-displays/remote-mcdu.md){.md-button}
