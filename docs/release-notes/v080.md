...
It's been a long road to our latest stable release, and we are happy to introduce some long awaited features, stunning visual elements, and even better realistic simulation of 
A320neo systems. This rather large feature release even contains our first implementation of using onboard systems externally on your mobile devices. FBW pilots, "Cleared for 
Takeoff"!
...
!!! warning "Important User Experience Changes"
    ...
    - Discontinuities are a feature and not a bug!
...
We have carefully crafted new textures in the virtual cockpit representative of a well used A320neo but reflective of it's relatively young age in the Airbus family. 

[images and expand more]
...
effect changes on the engines, and even landing lights that retract fully and independently. We've also finally allowed the first officer to use the flyPad.

![First Officer EFB](assets/efb-firstofficer.png){loading=lazy}

Our new PFD includes EIS S14 features with improve behaviours in numerous places. We have also made it lighter on frames improving performance in the simulator.
