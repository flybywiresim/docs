...
While most not be aware of this little fact is that we do actually have an onboard Flight Data Recorder (FDR) in the A32NX. This is a crucial component in the aircraft that 
records and logs various parameters and events. This data in real life is then used to analyze and investigate any incidents or accidents that may occur. 

For the purposes of simulation we use it for providing technical support to our users and analyzing the same parameters
