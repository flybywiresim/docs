...
- [FIX] Typo in event log of event A32NX.FCU_ALT_DEC <span class="author"> - @aguther (Andreas Guther)</span>
- [To sort] Added smoothing of H/PATH Phi-N signal <span class="author"> - @aguther (Andreas Guther)</span>
