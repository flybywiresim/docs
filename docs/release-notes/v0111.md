...
This update primarily addresses some minor issues that were present in our previous stable release. Specifically, we have resolved a problem related to the MCDU crashing when a runway is left undefined.
