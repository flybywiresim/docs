...
This release improves the general performance impact of the aircraft, improves some LNAV paths and fixes hardware 
bindings to pause the sim. An issue causing rolling oscillations for some users has also been fixed.
