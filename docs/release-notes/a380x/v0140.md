...
!!! tip "Microsoft Flight Simulator 2024"
    The aircraft is now compatible with MSFS 2024. [Add more here]

This release features a big fidelity upgrade for the A380X — with major advances across **FMS**, **FWS/ECAM**, **SURV/OANS**, **PFD/SD/MFD**, and **model/lighting** polish. 
...
Install or update via the [FlyByWire Installer](../../aircraft/install/fbw-versions.md). If you encounter problems, please visit our [Known Issues](../../aircraft/support/known-issues).
