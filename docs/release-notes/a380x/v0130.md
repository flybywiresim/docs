...
Welcome aboard the A380X v0.13.0 release, where we continue refining realism, systems behavior, and user experience. This release expands system fidelity, introduces new failure modes, enhances the Electronic Flight Bag, and polishes displays for improved workflow.
