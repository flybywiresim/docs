...
!!! warning "Take Note"
    ...
    Throttle detent calibration is now required - [Read Here](../fbw-a32nx/feature-guides/throttle-calibration.md)
...
Our sound engineer continuously tweaks and improved the digital soundscape from both within the flight deck and on the outside. Using real world references and verified by our pilot staff the A32NX now provides an immersive experience throughout the power up sequence, engine start, flight, cockpit interaction and aircraft shutdown.
