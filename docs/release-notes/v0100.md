...
There are also new NAVAID and SELECTED NAVAIDS pages, and the re-implementation of the RADIO NAV. We've also added new TUNE BBB FFF.FF and SPECIF NDB UNAVAIL messages.
