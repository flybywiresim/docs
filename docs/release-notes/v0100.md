...
We're excited to bring a slew of new features and various improvements in the A32NX. Terrain on ND is now available through our SimBridge, which allows sim pilots to have access to our external terrain database. We've got some improved visuals by way of interior and exterior lighting, as well as new UI elements in the flyPadOS. In the 
