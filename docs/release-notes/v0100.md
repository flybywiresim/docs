...
- [x] FMGC + FMS improvements including:
    ...
    - [x] FMS navaid autotuning, navigation and display, ILS course and slope information for database.
    - [x] Handles approach transitions hidden inside of other transitions with Navigraph data.
