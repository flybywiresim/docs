...
![FlyPad Wi-Fi](../fbw-a32nx/assets/flypados3/flypad-dashboard-connectivity.png){loading=lazy}

Icon Crossed             |  Icon Normal
:-------------------------:|:-------------------------:
![Wi-Fi Crossed](../fbw-a32nx/assets/flypados3/flypad-status-crossed.png){loading=lazy}  |  ![Wi-Fi Normal](../fbw-a32nx/assets/flypados3/flypad-status-normal.png){loading=lazy}
