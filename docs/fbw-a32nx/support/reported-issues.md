...
!!! error  "STOP - Read this First"
    ...
    **Throttle Calibration is Required** - [Guide Here](../feature-guides/flyPad/throttle-calibration.md)
    ...
    FBW Installer - [Download Here](https://api.flybywiresim.com/installer){target=new} / *Sim Version: 1.20.6.0*
...
<sub> Currently only Development or Experimental are compatible.
