...
!!! tip ""
    ...
    - [Loading a Flight Plan from SimBrief](simbrief.md) (recommended for MSFS 2020)
    - [Using MSFS Flighht Planning Tools](#msfs-flight-planning-tools)

## MSFS Flight Planning Tools

See [Flight Planning with MSFS](../../common/flight-planning-with-msfs.md) for more information on the different methods to load a flight plan into the A380X and how to use it in combination with MSFS flight planning tools.
