...
![FMS Wind Request Received](../assets/feature-guides/simbrief/fms-init-wind-recieved.jpg){loading=lazy}


We can now check that the wind data was loaded correctly by navigating to the `WIND` page and verifying the winds were automatically populated. 
