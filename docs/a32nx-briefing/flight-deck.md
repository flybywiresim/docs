...
<div style="position: relative;">
    ...
    <!-- OVHD FWD -->
    <a title="PA and Cockpit Door Video" href="#"><div style="position: absolute; left: 22.5%; top: 23.8%; width: 12.5%; height: 1.7%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="ADIRS Panel" href="#"><div style="position: absolute; left: 22.5%; top: 25.5%; width: 12.6%; height: 4.5%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Flight Control Panel Left" href="#"><div style="position: absolute; left: 22.5%; top: 31.2%; width: 12.6%; height: 1.7%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Evacuation Panel" href="#"><div style="position: absolute; left: 22.5%; top: 32.9%; width: 12.6%; height: 1.6%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Emergency Electric Power Panel" href="#"><div style="position: absolute; left: 22.5%; top: 34.5%; width: 12.6%; height: 1.7%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Ground Proximity Warning Panel" href="#"><div style="position: absolute; left: 22.5%; top: 36.2%; width: 12.6%; height: 1.5%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Voice Recoder Panel" href="#"><div style="position: absolute; left: 22.5%; top: 37.7%; width: 12.6%; height: 1.3%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    ...
    <a title="Cabin Pressure Control Panel" href="#"><div style="position: absolute; left: 52.3%; top: 40.4%; width: 12.8%; height: 1.7%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="External Lights Panel" href="#"><div style="position: absolute; left: 35.1%; top: 42.1%; width: 13.3%; height: 3.2%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="APU Panel" href="#"><div style="position: absolute; left: 48.4%; top: 42.1%; width: 3.2%; height: 3.2%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Internal Lighting Panel" href="#"><div style="position: absolute; left: 51.6%; top: 42.1%; width: 13.5%; height: 1.4%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Sign Panel" href="#"><div style="position: absolute; left: 51.6%; top: 43.5%; width: 13.5%; height: 1.6%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="3rd Audio Control Panel" href="#"><div style="position: absolute; left: 65.1%; top: 23.3%; width: 12.6%; height: 3.2%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Flight Control Panel Right" href="#"><div style="position: absolute; left: 65.1%; top: 33%; width: 12.6%; height: 1.7%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Cargo Ventilation Panel" href="#"><div style="position: absolute; left: 65.1%; top: 34.7%; width: 12.6%; height: 2.4%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Cargo Smoke Panel" href="#"><div style="position: absolute; left: 65.1%; top: 37.1%; width: 12.6%; height: 1.65%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
    <a title="Ventilation Panel" href="#"><div style="position: absolute; left: 65.1%; top: 38.75%; width: 12.6%; height: 1.6%; background-color: rgba(255, 0, 0, .25); border: 1px solid yellow;"></div></a>
